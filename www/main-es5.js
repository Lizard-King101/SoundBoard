...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"]],
      providers: [_socket_service__WEBPACK_IMPORTED_MODULE_10__["SocketService"], _data_service__WEBPACK_IMPORTED_MODULE_9__["DataManagerService"]],
    ...
    function () {
      ...
      _createClass(DataManagerService, [{
        ...
        value: function post(command, data) {
          ...
          return new Promise(function (resolve, reject) {
            _this.http.post('/' + command, JSON.stringify(data), {
              headers: headers
                      ...
                      _this2.http.post('/' + command, data, {
                        ...
                        switch (event.type) {
                          ...
                          case _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpEventType"].Response:
                            // complete
                            // load.dismiss();
                            _this2.uploadedPercentage = 0;
                            res(event.body);
                            break;

                          case 1:
                            {
                              if (Math.round(_this2.uploadedPercentage) !== Math.round(event['loaded'] / event['total'] * 100)) {
                                _this2.uploadedPercentage = event['loaded'] / event['total'] * 100; // this.event.publish('loader', this.uploadedPercentage);
                              }
